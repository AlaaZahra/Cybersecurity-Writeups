...
!\[TeamCity Version](images/03-teamcity-version.png)
...
!\[CVE Research](images/04-cve-research.png)
...
The `SYSTEM\_ADMIN` role gave the account administrative privileges. The scope value `g` indicated that the permissions applied globally.
...
!\[Malicious Plugin Upload](images/05-plugin-upload.png)
...
!\[Web-Shell Requests](images/06-webshell-requests.png)
...
!\[Credentials File Tampering](images/07-credentials-tampering.png)
...
!\[Container Escape Attempt](images/08-container-escape.png)
...
\- Detect newly created users receiving the global `SYSTEM\_ADMIN` role.
